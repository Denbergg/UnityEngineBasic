...
namespace BinaryTree
{
    ...
    internal class MyBinaryTree<T>
    {
        ...
        public void Add(T item)
        {
            if (_root != null)
            {
                ...
                while (_tmp1 != null)
                {
                    ...
                    {
                        throw new InvalidOperationException($"[MyBinaryTree] : {item} 은 이미 존재합니다. 중복 허용하지않음.");
                    }
                }
            }
            else
        ...
        // 탐색 알고리즘
        // 위 삽입 알고리즘을 참고하여 탐색알고리즘을 완성해 보세요
        ...
        // 더이상 왼쪽이 없더라도 오른쪽이 있으면 또 오른쪽자식으로 가서 가장 왼쪽 leaf를 탐색하는것을 반복한 후
